...
public class TelaCadrasto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Materias (Opcional): ");

        jTextField8.setBackground(new java.awt.Color(26, 87, 82));
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        String mae = jTextField5.getText();
        ...
        if (tipoUser.equalsIgnoreCase("professor") && formacao.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatórios!");
            return;
        }

        if (tipoUser.equalsIgnoreCase("aluno") && (pai.isEmpty() || mae.isEmpty())) {
            JOptionPane.showMessageDialog(null, "Preencha todos os campos obrigatórios!");
            return;
        }
