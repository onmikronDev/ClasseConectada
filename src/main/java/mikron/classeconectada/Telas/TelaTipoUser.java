 ...
 * @author mikron
 */
public class TelaTipoUser extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaTipoUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
